...
type MsgSubmitProposal struct {
	...
	ProposalType   ProposalKind   `json:"proposal-type"`   //  Type of proposal. Initial set {PlainTextProposal, SoftwareUpgradeProposal}
	Proposer       sdk.AccAddress `json:"proposer"`        //  Address of the proposer
	InitialDeposit sdk.Coins      `json:"initial-deposit"` //  Initial deposit paid by sender. Must be strictly positive.
}
